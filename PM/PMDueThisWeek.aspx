<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="PMDueThisWeek.aspx.cs" Inherits="PMDueThisWeek" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<fieldset><legend>The following is a list of machines that are due this week for PM. 
    <br />
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataSourceID="dsPMsDueThisWeek" Width="791px" CellPadding="4" ForeColor="#333333" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="NEXTPMDATE" DataFormatString="{0:d}" 
                HeaderText="PM Due" SortExpression="NEXTPMDATE" />
        </Columns>
    ...
    <asp:SqlDataSource ID="dsPMsDueThisWeek" runat="server" 
        ...
        SelectCommand="SELECT distinct Machinenumber, frequency, NEXTPMDATE, division 
	                    ...
	                    WHERE DATEPART(wk,NEXTPMDATE) = DATEPART(wk,getdate())

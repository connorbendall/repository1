<%@ Page Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="PMDueWeek3.aspx.cs" Inherits="PMDueWeek3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<fieldset><legend>The following is a list of machines that are due week 3 for PM. 
    <br />
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataSourceID="dsPMsDueWeek3" Width="791px" CellPadding="4" ForeColor="#333333" 
    ...
    <asp:SqlDataSource ID="dsPMsDueWeek3" runat="server" 
        ...
        SelectCommand="SELECT distinct Machinenumber, frequency, NEXTPMDATE, division 
	                    ...
	                    WHERE DATEPART(wk,NEXTPMDATE) = DATEPART(wk,getdate()+14)
